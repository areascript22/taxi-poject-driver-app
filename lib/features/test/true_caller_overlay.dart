...
class TrueCallerOverlay1 extends StatefulWidget {
  const TrueCallerOverlay1({Key? key}) : super(key: key);

  @override
  State<TrueCallerOverlay1> createState() => _TrueCallerOverlayState();
}

class _TrueCallerOverlayState extends State<TrueCallerOverlay1> {
  bool isGold = true;
